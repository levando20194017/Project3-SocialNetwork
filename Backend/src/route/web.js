...
let initWebRoutes = (app) => {
  ...
  router.post(
    ...
    auth,
    courseController.handleCreateNewCourse
  );
  router.delete(
    "/api/delete-course",
    auth,
  ...
  router.post(
    ...
    auth,
    lessonController.handleCreateNewLesson
  );
  router.put("/api/edit-lesson", auth, lessonController.handleEditLesson);
  router.delete(
    "/api/delete-lesson",
    auth,
    lessonController.handleDeleteLesson
  );
  ...
  router.post(
    ...
    auth,
    videoController.handleCreateNewVideo
  );
  ...
  router.get(
    "/api/comment/get-all-likes",
    likeCommentController.handleGetAllLikes
  );
  router.post(
    "/api/comment/isliked",
    likeCommentController.handleCreateIsLiked
  );

  router.post(
    "/api/course/register",
    enrollmentController.handleRegisterCourse
  );
  router.get(
    "/api/get-all-usersRegisterCourse",
    enrollmentController.handleGetAllUsersRegisterCourse
  );

  router.post(
    "/api/progress/create-progress-course",
    progressController.handleCreateProgressOfCourse
  );
  router.get(
    "/api/progress/get-progress-course",
    progressController.handleGetProgress
  );
